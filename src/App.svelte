...
<main>
	<div id = "page-container">
		<div id="header"><b>Nari Johnson</b></div>
		<div id = "links"><a href = "https://scholar.google.com/citations?hl=en&user=otKyVIAAAAAJ">Google Scholar</a> <img src = {pagebreak_fp} width = "20"/> <a href = "https://github.com/njohnson99">Github</a> <img src = {pagebreak_fp} width = "20"/> <a href = "https://twitter.com/narijohnson">Twitter</a> </div>
...
@font-face {
	...
	src: local('PP Editorial New'), url('./fonts/PPEditorialNew-Regular.woff') format('woff');
	unicode-range: U+0000-00FF, U+0131, U+0152-0153, U+02BB-02BC, U+02C6, U+02DA, U+02DC, U+2000-206F, U+2074, U+20AC, U+2122, U+2191, U+2193, U+2212, U+2215, U+FEFF, U+FFFD;
	font-weight: bold;
}
@font-face {
	font-family: 'Editorial';
	src: local('PP Editorial New'), url('./fonts/PPEditorialNew-UltralightItalic.woff') format('woff');
	unicode-range: U+0000-00FF, U+0131, U+0152-0153, U+02BB-02BC, U+02C6, U+02DA, U+02DC, U+2000-206F, U+2074, U+20AC, U+2122, U+2191, U+2193, U+2212, U+2215, U+FEFF, U+FFFD;
	font-style: italic;
}
@font-face {
	font-family: 'Editorial';
	src: local('PP Editorial New'), local('Editorial-Ultralight'), url('./fonts/PPEditorialNew-Ultralight.woff') format('woff');
	unicode-range: U+0000-00FF, U+0131, U+0152-0153, U+02BB-02BC, U+02C6, U+02DA, U+02DC, U+2000-206F, U+2074, U+20AC, U+2122, U+2191, U+2193, U+2212, U+2215, U+FEFF, U+FFFD;
}
