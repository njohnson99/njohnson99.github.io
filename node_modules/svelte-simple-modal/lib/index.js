import { SvelteComponent, init, safe_not_equal, append_styles, element, space, create_component, attr, null_to_empty, toggle_class, insert, append, mount_component, listen, is_function, transition_in, empty, group_outros, transition_out, check_outros, detach, destroy_component, construct_svelte_component, add_render_callback, create_bidirectional_transition, run_all, create_slot, update_slot_base, get_all_dirty_from_scope, get_slot_changes, globals, noop, binding_callbacks } from 'svelte/internal';
import * as svelte from 'svelte';
import { createEventDispatcher } from 'svelte';
import { fade } from 'svelte/transition';

/* src/Modal.svelte generated by Svelte v3.53.1 */
 ...
 */
	...
	$$self.$$set = $$props => {
		...
		if ('setContext' in $$props) $$invalidate(40, setContext = $$props.setContext);
